...
const CORE = [
  ...
  'assets/icon.svg',
  'assets/css/style.css?v=9.0',
  'assets/js/lib/util.js?v=9.0',
  'assets/js/lib/mathdsp.js?v=9.0',
  'assets/js/lib/plots.js?v=9.0',
  'assets/js/lib/fx.js?v=9.0',
  'assets/js/lib/mathinput.js?v=9.0',
  'assets/js/lib/blocksolve.js?v=9.0',
  'assets/js/lib/transforms.js?v=9.0',
  'assets/js/lib/odesolve.js?v=9.0',
  'assets/js/lib/statespace.js?v=9.0',
  'assets/js/lib/project.js?v=9.0',
  'assets/js/lib/toolbar.js?v=9.0',
  'assets/js/lib/palette.js?v=9.0',
  'assets/js/lib/workerpool.js?v=9.0',
  'assets/js/app.js?v=9.0',
  'assets/js/modules/workbench.js?v=9.0',
  'assets/js/modules/fourier-series.js?v=9.0',
  'assets/js/modules/fourier-transform.js?v=9.0',
  'assets/js/modules/laplace.js?v=9.0',
  'assets/js/modules/system.js?v=9.0',
  'assets/js/modules/pid.js?v=9.0',
  'assets/js/modules/zt.js?v=9.0',
  'assets/js/modules/blockdiag.js?v=9.0',
  'assets/js/modules/derive.js?v=9.0',
  'assets/js/modules/explore.js?v=9.0',
