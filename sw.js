...
const CORE = [
  ...
  'assets/icon.svg',
  'assets/css/style.css?v=8.8',
  'assets/js/lib/util.js?v=8.8',
  'assets/js/lib/mathdsp.js?v=8.8',
  'assets/js/lib/plots.js?v=8.8',
  'assets/js/lib/fx.js?v=8.8',
  'assets/js/lib/mathinput.js?v=8.8',
  'assets/js/lib/blocksolve.js?v=8.8',
  'assets/js/lib/transforms.js?v=8.8',
  'assets/js/lib/odesolve.js?v=8.8',
  'assets/js/lib/statespace.js?v=8.8',
  'assets/js/lib/project.js?v=8.8',
  'assets/js/lib/toolbar.js?v=8.8',
  'assets/js/lib/palette.js?v=8.8',
  'assets/js/lib/workerpool.js?v=8.8',
  'assets/js/app.js?v=8.8',
  'assets/js/modules/workbench.js?v=8.8',
  'assets/js/modules/fourier-series.js?v=8.8',
  'assets/js/modules/fourier-transform.js?v=8.8',
  'assets/js/modules/laplace.js?v=8.8',
  'assets/js/modules/system.js?v=8.8',
  'assets/js/modules/pid.js?v=8.8',
  'assets/js/modules/zt.js?v=8.8',
  'assets/js/modules/blockdiag.js?v=8.8',
  'assets/js/modules/derive.js?v=8.8',
  'assets/js/modules/explore.js?v=8.8',
